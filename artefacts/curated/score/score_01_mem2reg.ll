; ModuleID = '/workspace/artefacts/curated/score/score_O0.bc'
...
entry:
  ...
  %mul = mul nsw i32 %scale, 32, !dbg !19
    #dbg_value(i32 %mul, !20, !DIExpression(), !17)
  %mul1 = mul nsw i32 %scale, %scale, !dbg !21
  %mul2 = mul nsw i32 %scale, %scale, !dbg !22
  %sub = sub nsw i32 %mul1, %mul2, !dbg !23
    #dbg_value(i32 %sub, !24, !DIExpression(), !17)
  %sub3 = sub nsw i32 %x, 128, !dbg !25
    #dbg_value(i32 %sub3, !26, !DIExpression(), !17)
  %mul4 = mul nsw i32 %sub3, %scale, !dbg !27
    #dbg_value(i32 %mul4, !28, !DIExpression(), !17)
  %cmp = icmp sgt i32 %mul4, %mul, !dbg !29
...
if.end:                                           ; preds = %entry
  %add = add nsw i32 %mul4, %sub, !dbg !32
  br label %return, !dbg !33

return:                                           ; preds = %if.end, %if.then
  %retval.0 = phi i32 [ %mul, %if.then ], [ %add, %if.end ], !dbg !17
...
!22 = !DILocation(line: 3, column: 42, scope: !10)
!23 = !DILocation(line: 3, column: 34, scope: !10)
!24 = !DILocalVariable(name: "wasted", scope: !10, file: !11, line: 3, type: !14)
!25 = !DILocation(line: 4, column: 22, scope: !10)
!26 = !DILocalVariable(name: "adjusted", scope: !10, file: !11, line: 4, type: !14)
!27 = !DILocation(line: 5, column: 29, scope: !10)
!28 = !DILocalVariable(name: "weighted", scope: !10, file: !11, line: 5, type: !14)
!29 = !DILocation(line: 7, column: 18, scope: !30)
!30 = distinct !DILexicalBlock(scope: !10, file: !11, line: 7, column: 9)
!31 = !DILocation(line: 8, column: 9, scope: !30)
!32 = !DILocation(line: 10, column: 21, scope: !10)
