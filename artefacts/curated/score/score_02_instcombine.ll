; ModuleID = '/workspace/artefacts/curated/score/score_01_mem2reg.ll'
...
if.end:                                           ; preds = %entry
    #dbg_value(i32 0, !21, !DIExpression(), !17)
  br label %return, !dbg !29

return:                                           ; preds = %if.end, %if.then
  %retval.0 = phi i32 [ %mul, %if.then ], [ %mul4, %if.end ], !dbg !17
...
!30 = !DILocation(line: 11, column: 1, scope: !10)
