; ModuleID = '/workspace/artefacts/curated/binary_search/binary_search_10_loop_cleanup.ll'
...
entry:
  ...
  %cmp2 = icmp sgt i32 %n, 0, !dbg !25
  br i1 %cmp2, label %while.body.preheader, label %while.end, !dbg !26

while.body.preheader:                             ; preds = %entry
  br label %while.body, !dbg !26

while.body:                                       ; preds = %while.body.preheader, %while.body
  %hi.04 = phi i32 [ %hi.1, %while.body ], [ %n, %while.body.preheader ]
  %lo.03 = phi i32 [ %lo.1, %while.body ], [ 0, %while.body.preheader ]
  ...
  br i1 %cmp, label %while.body, label %while.end.loopexit, !dbg !26, !llvm.loop !36

while.end.loopexit:                               ; preds = %while.body
  %lo.1.lcssa = phi i32 [ %lo.1, %while.body ], !dbg !35
  br label %while.end, !dbg !39

while.end:                                        ; preds = %while.end.loopexit, %entry
  %lo.0.lcssa = phi i32 [ 0, %entry ], [ %lo.1.lcssa, %while.end.loopexit ], !dbg !20
