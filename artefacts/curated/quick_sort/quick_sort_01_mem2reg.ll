; ModuleID = '/workspace/artefacts/curated/quick_sort/quick_sort_O0.bc'
...
for.body:                                         ; preds = %for.cond
  ...
  %cmp3 = icmp sle i32 %1, %0, !dbg !55
  br i1 %cmp3, label %if.then, label %if.end, !dbg !55
...
for.inc:                                          ; preds = %if.end
  %inc12 = add nsw i32 %j.0, 1, !dbg !68
    #dbg_value(i32 %inc12, !44, !DIExpression(), !46)
  br label %for.cond, !dbg !69, !llvm.loop !70

for.end:                                          ; preds = %for.cond
  %add = add nsw i32 %i.0, 1, !dbg !73
  %idxprom14 = sext i32 %add to i64, !dbg !74
  %arrayidx15 = getelementptr inbounds i32, ptr %a, i64 %idxprom14, !dbg !74
  %4 = load i32, ptr %arrayidx15, align 4, !dbg !74
    #dbg_value(i32 %4, !75, !DIExpression(), !37)
  %idxprom16 = sext i32 %high to i64, !dbg !76
  %arrayidx17 = getelementptr inbounds i32, ptr %a, i64 %idxprom16, !dbg !76
  %5 = load i32, ptr %arrayidx17, align 4, !dbg !76
  %add18 = add nsw i32 %i.0, 1, !dbg !77
  %idxprom19 = sext i32 %add18 to i64, !dbg !78
  %arrayidx20 = getelementptr inbounds i32, ptr %a, i64 %idxprom19, !dbg !78
  store i32 %5, ptr %arrayidx20, align 4, !dbg !79
  %idxprom21 = sext i32 %high to i64, !dbg !80
  %arrayidx22 = getelementptr inbounds i32, ptr %a, i64 %idxprom21, !dbg !80
  store i32 %4, ptr %arrayidx22, align 4, !dbg !81
  %add23 = add nsw i32 %i.0, 1, !dbg !82
  ret i32 %add23, !dbg !83
}
...
!67 = !DILocation(line: 15, column: 5, scope: !54)
!68 = !DILocation(line: 7, column: 33, scope: !50)
!69 = !DILocation(line: 7, column: 5, scope: !50)
!70 = distinct !{!70, !51, !71, !72}
!71 = !DILocation(line: 15, column: 5, scope: !45)
!72 = !{!"llvm.loop.mustprogress"}
!73 = !DILocation(line: 17, column: 19, scope: !33)
!74 = !DILocation(line: 17, column: 15, scope: !33)
!75 = !DILocalVariable(name: "tmp", scope: !33, file: !11, line: 17, type: !15)
!76 = !DILocation(line: 18, column: 16, scope: !33)
!77 = !DILocation(line: 18, column: 9, scope: !33)
!78 = !DILocation(line: 18, column: 5, scope: !33)
!79 = !DILocation(line: 18, column: 14, scope: !33)
!80 = !DILocation(line: 19, column: 5, scope: !33)
!81 = !DILocation(line: 19, column: 13, scope: !33)
!82 = !DILocation(line: 21, column: 14, scope: !33)
!83 = !DILocation(line: 21, column: 5, scope: !33)
