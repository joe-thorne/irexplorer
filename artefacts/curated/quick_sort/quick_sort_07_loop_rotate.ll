; ModuleID = '/workspace/artefacts/curated/quick_sort/quick_sort_06_loop_canonical.ll'
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %j.03 = phi i32 [ %low, %for.body.lr.ph ], [ %inc12, %for.inc ]
  %i.02 = phi i32 [ %sub, %for.body.lr.ph ], [ %i.1, %for.inc ]
    #dbg_value(i32 %j.03, !44, !DIExpression(), !46)
    #dbg_value(i32 %i.02, !43, !DIExpression(), !37)
  %idxprom1 = sext i32 %j.03 to i64, !dbg !50
  %arrayidx2 = getelementptr inbounds i32, ptr %a, i64 %idxprom1, !dbg !50
  %1 = load i32, ptr %arrayidx2, align 4, !dbg !50
  %cmp3.not = icmp sgt i32 %1, %0, !dbg !53
...
if.then:                                          ; preds = %for.body
  ...
  %2 = load i32, ptr %arrayidx5, align 4, !dbg !56
    #dbg_value(i32 %2, !57, !DIExpression(), !58)
  store i32 %1, ptr %arrayidx5, align 4, !dbg !59
  store i32 %2, ptr %arrayidx2, align 4, !dbg !60
  br label %for.inc, !dbg !61

for.inc:                                          ; preds = %if.then, %for.body
  %i.1 = phi i32 [ %inc, %if.then ], [ %i.02, %for.body ], !dbg !37
    #dbg_value(i32 %i.1, !43, !DIExpression(), !37)
  %inc12 = add nsw i32 %j.03, 1, !dbg !62
    #dbg_value(i32 %inc12, !44, !DIExpression(), !46)
  %cmp = icmp slt i32 %inc12, %high, !dbg !47
  br i1 %cmp, label %for.body, label %for.cond.for.end_crit_edge, !dbg !49, !llvm.loop !63
...
for.end:                                          ; preds = %for.cond.for.end_crit_edge, %entry
  ...
  %3 = sext i32 %i.0.lcssa to i64, !dbg !66
  %4 = getelementptr i32, ptr %a, i64 %3, !dbg !66
  %arrayidx15 = getelementptr i8, ptr %4, i64 4, !dbg !66
  %5 = load i32, ptr %arrayidx15, align 4, !dbg !66
    #dbg_value(i32 %5, !67, !DIExpression(), !37)
  %6 = load i32, ptr %arrayidx, align 4, !dbg !68
  store i32 %6, ptr %arrayidx15, align 4, !dbg !69
  store i32 %5, ptr %arrayidx, align 4, !dbg !70
