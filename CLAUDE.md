...
Next: review E3 in `../Docs/evaluation/e3-review.md` before E4. Joe reviewed E0–E2 with no amendments; no instrument correction was explicitly accepted. E2's verified canonical C and bidirectional source coordination remain. E3 adds independent previous/next controls, readable ordinal/no-op/final/O3 labels, whole-example recorded summaries with full evidence and provenance, separate selection confidence, and directed CFG lanes/self-loops with readable labels and text edges. E1's synthetic shell remains; actual forms, timing, drafts, and collection are E4–E8. Preview: `http://127.0.0.1:8000/#/explore` and `/#/study`. Verification: 71 browser assertions, six visually inspected captures, and 58 backend tests pass; see `docs/evaluation-captures/e3-comparisons.md`. Physical-keyboard/wider accessibility and S1.8 remain E7. Instruments and canonical artefacts are unchanged. Live arbitrary input remains Phase 5 only after the S2.6 activation gate.
