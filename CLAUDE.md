...
Next: E0–E7 review is complete, as confirmed by Joe on 9 September 2026. E8 delivers local container version 0.1.0 at `http://localhost:8000`, ready for extensive testing. Use the application README for Compose, versioning, export, backup, and verification commands. Keep subsequent handovers concise and update existing documentation only; no new review packs or Markdown directories. Earlier amendment notes below are historical.
...
- `src/backend/evaluation/` — participant-only definition/validation, separate study router/SQLite service, and private researcher CLI.
