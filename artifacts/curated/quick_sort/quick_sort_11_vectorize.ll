; ModuleID = '/workspace/artifacts/curated/quick_sort/quick_sort_10_loop_cleanup.ll'
...
for.body:                                         ; preds = %for.inc, %for.body.lr.ph
  ...
  %i.02 = phi i32 [ %i.1, %for.inc ], [ %sub, %for.body.lr.ph ]
...
for.inc:                                          ; preds = %if.then, %for.body
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count, !dbg !47
  br i1 %exitcond.not, label %for.end.loopexit, label %for.body, !dbg !49, !llvm.loop !63

for.end.loopexit:                                 ; preds = %for.inc
  %i.1.lcssa = phi i32 [ %i.1, %for.inc ], !dbg !37
  br label %for.end, !dbg !66

for.end:                                          ; preds = %for.end.loopexit, %entry
  %i.0.lcssa = phi i32 [ %sub, %entry ], [ %i.1.lcssa, %for.end.loopexit ], !dbg !37
