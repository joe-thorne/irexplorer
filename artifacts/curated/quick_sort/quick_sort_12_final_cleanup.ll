; ModuleID = '/workspace/artifacts/curated/quick_sort/quick_sort_11_vectorize.ll'
...
for.inc:                                          ; preds = %if.then, %for.body
  ...
  br i1 %exitcond.not, label %for.end, label %for.body, !dbg !49, !llvm.loop !63

for.end:                                          ; preds = %for.inc, %entry
  %i.0.lcssa = phi i32 [ %sub, %entry ], [ %i.1, %for.inc ], !dbg !37
