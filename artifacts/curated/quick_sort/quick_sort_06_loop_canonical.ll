; ModuleID = '/workspace/artifacts/curated/quick_sort/quick_sort_05_cleanup.ll'
...
if.then:                                          ; preds = %for.body
  ...
  store i32 %1, ptr %arrayidx5, align 4, !dbg !61
  store i32 %2, ptr %arrayidx2, align 4, !dbg !62
  br label %for.inc, !dbg !63

for.inc:                                          ; preds = %if.then, %for.body
  %i.1 = phi i32 [ %inc, %if.then ], [ %i.0, %for.body ], !dbg !37
    #dbg_value(i32 %i.1, !43, !DIExpression(), !37)
  %inc12 = add nsw i32 %j.0, 1, !dbg !64
    #dbg_value(i32 %inc12, !44, !DIExpression(), !46)
  br label %for.cond, !dbg !65, !llvm.loop !66

for.end:                                          ; preds = %for.cond
  %i.0.lcssa = phi i32 [ %i.0, %for.cond ], !dbg !37
  %3 = sext i32 %i.0.lcssa to i64, !dbg !69
  %4 = getelementptr i32, ptr %a, i64 %3, !dbg !69
  %arrayidx15 = getelementptr i8, ptr %4, i64 4, !dbg !69
  %5 = load i32, ptr %arrayidx15, align 4, !dbg !69
    #dbg_value(i32 %5, !70, !DIExpression(), !37)
  %6 = load i32, ptr %arrayidx, align 4, !dbg !71
  store i32 %6, ptr %arrayidx15, align 4, !dbg !72
  store i32 %5, ptr %arrayidx, align 4, !dbg !73
  %add23 = add nsw i32 %i.0.lcssa, 1, !dbg !74
  ret i32 %add23, !dbg !75
}
...
!62 = !DILocation(line: 13, column: 18, scope: !57)
!63 = !DILocation(line: 14, column: 9, scope: !57)
!64 = !DILocation(line: 7, column: 33, scope: !50)
!65 = !DILocation(line: 7, column: 5, scope: !50)
!66 = distinct !{!66, !51, !67, !68}
!67 = !DILocation(line: 15, column: 5, scope: !45)
!68 = !{!"llvm.loop.mustprogress"}
!69 = !DILocation(line: 17, column: 15, scope: !33)
!70 = !DILocalVariable(name: "tmp", scope: !33, file: !11, line: 17, type: !15)
!71 = !DILocation(line: 18, column: 16, scope: !33)
!72 = !DILocation(line: 18, column: 14, scope: !33)
!73 = !DILocation(line: 19, column: 13, scope: !33)
!74 = !DILocation(line: 21, column: 14, scope: !33)
!75 = !DILocation(line: 21, column: 5, scope: !33)
