; ModuleID = '/workspace/artifacts/curated/quick_sort/quick_sort_01_mem2reg.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp3.not, label %if.end, label %if.then, !dbg !55
...
for.end:                                          ; preds = %for.cond
  %4 = sext i32 %i.0 to i64, !dbg !73
  %5 = getelementptr i32, ptr %a, i64 %4, !dbg !73
  %arrayidx15 = getelementptr i8, ptr %5, i64 4, !dbg !73
  %6 = load i32, ptr %arrayidx15, align 4, !dbg !73
    #dbg_value(i32 %6, !74, !DIExpression(), !37)
  %idxprom16 = sext i32 %high to i64, !dbg !75
  %arrayidx17 = getelementptr inbounds i32, ptr %a, i64 %idxprom16, !dbg !75
  %7 = load i32, ptr %arrayidx17, align 4, !dbg !75
  %8 = sext i32 %i.0 to i64, !dbg !76
  %9 = getelementptr i32, ptr %a, i64 %8, !dbg !76
  %arrayidx20 = getelementptr i8, ptr %9, i64 4, !dbg !76
  store i32 %7, ptr %arrayidx20, align 4, !dbg !77
  %idxprom21 = sext i32 %high to i64, !dbg !78
  %arrayidx22 = getelementptr inbounds i32, ptr %a, i64 %idxprom21, !dbg !78
  store i32 %6, ptr %arrayidx22, align 4, !dbg !79
  %add23 = add nsw i32 %i.0, 1, !dbg !80
  ret i32 %add23, !dbg !81
}
...
!73 = !DILocation(line: 17, column: 15, scope: !33)
!74 = !DILocalVariable(name: "tmp", scope: !33, file: !11, line: 17, type: !15)
!75 = !DILocation(line: 18, column: 16, scope: !33)
!76 = !DILocation(line: 18, column: 5, scope: !33)
!77 = !DILocation(line: 18, column: 14, scope: !33)
!78 = !DILocation(line: 19, column: 5, scope: !33)
!79 = !DILocation(line: 19, column: 13, scope: !33)
!80 = !DILocation(line: 21, column: 14, scope: !33)
!81 = !DILocation(line: 21, column: 5, scope: !33)
