; ModuleID = '/workspace/artifacts/curated/binary_search/binary_search_02_instcombine.ll'
...
while.end:                                        ; preds = %while.cond
  %cmp3 = icmp slt i32 %lo.0, %n, !dbg !40
  br i1 %cmp3, label %land.lhs.true, label %if.end8, !dbg !42

land.lhs.true:                                    ; preds = %while.end
  %idxprom4 = sext i32 %lo.0 to i64, !dbg !43
...
return:                                           ; preds = %land.lhs.true, %if.end8
  %retval.0 = phi i32 [ -1, %if.end8 ], [ %lo.0, %land.lhs.true ], !dbg !20
