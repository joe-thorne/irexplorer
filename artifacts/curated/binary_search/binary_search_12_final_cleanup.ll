; ModuleID = '/workspace/artifacts/curated/binary_search/binary_search_11_vectorize.ll'
...
entry:
  ...
  br i1 %cmp2, label %while.body, label %while.end, !dbg !26

while.body:                                       ; preds = %entry, %while.body
  %hi.04 = phi i32 [ %hi.1, %while.body ], [ %n, %entry ]
  %lo.03 = phi i32 [ %lo.1, %while.body ], [ 0, %entry ]
  ...
  br i1 %cmp, label %while.body, label %while.end, !dbg !26, !llvm.loop !36

while.end:                                        ; preds = %while.body, %entry
  %lo.0.lcssa = phi i32 [ 0, %entry ], [ %lo.1, %while.body ], !dbg !20
