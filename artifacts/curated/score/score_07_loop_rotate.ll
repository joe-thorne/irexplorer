; ModuleID = '/workspace/artifacts/curated/score/score_06_loop_canonical.ll'
...
entry:
  ...
  %mul.mul4 = call i32 @llvm.smin.i32(i32 %mul4, i32 %mul), !dbg !17
  ret i32 %mul.mul4, !dbg !26
}
...
!26 = !DILocation(line: 11, column: 1, scope: !10)
